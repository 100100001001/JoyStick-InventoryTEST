...
public class InventoryUI : MonoBehaviour
{
    ...
    // Inventory UI 오브젝트의 Open 또는 Close 상태를 표현할 bool형 변수
    ...
    void Start()
    {
        ...
        // inventoryPanel의 활성화 상태를 activeInventory값(비활성)으로 변경
    ...
    void Update()
    {
        ...
        {
            // 현재 activeInventory의 반대 상태(Not)를 activeInventory에 담기
            activeInventory = !activeInventory;

            // inventoryPanel의 활성화 상태를 activeInventory값으로 변경
            inventoryPanel.SetActive(activeInventory);
        }
    }
}
